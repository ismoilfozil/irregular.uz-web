...
function VerbsPage() {
  ...
  return (
    <div className="container mx-auto px-6 py-12 md:py-16">
      ...
      <div className="sticky top-16 z-30 bg-background/80 backdrop-blur-xl py-4 -mx-6 px-6 mb-6 border-b border-border/60">
      ...
      <div className="rounded-2xl border border-border/60 overflow-hidden shadow-soft bg-card">
        <div className="grid grid-cols-12 px-6 py-4 text-xs font-semibold uppercase tracking-wider text-muted-foreground bg-secondary/40 border-b border-border/60">
        ...
        {filtered.length === 0 ? (
          ...
          <div className="divide-y divide-border/50">
            {filtered.map((v) => (
              <div
                key={v.base}
                className="grid grid-cols-12 px-6 py-4 hover:bg-secondary/40 transition-colors"
              >
